...
df = pd.read_csv("cluster_data/cluster_BTX_19.csv",low_memory = False)
...
state_size = 7
harry = library.agents.distAgentsWIP2.QRAgent(state_size, params["action_values"], "CX Harry11 U 10p10",C=100, alternative_target = True,UCB=True,UCBc = 200,tree_horizon = 5,orderbook =True)#,market_data_size=n_hist_prices)
...
my_simulator.train(15000,epsilon_decay =0.9999)
