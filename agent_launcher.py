...
# Define Agents
quentin = library.agents.distAgentsWIP2.QRAgent(state_size, params["action_values"], "Quentin",C=100, alternative_target = True,UCB=True,UCBc = 100,tree_horizon = 4,market_data_size=n_hist_prices)
